<header class="navbar navbar-expand-md navbar-overlap d-print-none shadow-none" style="background-color: #00067d;"
    data-bs-theme="dark">
            ...
            <div class="d-flex flex-column flex-md-row flex-fill align-items-stretch align-items-md-center">
                <ul class="navbar-nav">
                    ...
                    <x-nav-link active="{{ request()->routeIs('admin.dashboard') }}"
                        href="{{ route('admin.dashboard') }}" label="Home">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                            stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round"
                            stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                    ...
                    {{-- Nav Link: Companies --}}
                    <x-nav-link active="{{ request()->routeIs('admin.companies.*') }}"
                        href="{{ route('admin.companies.index') }}" label="Companies">
